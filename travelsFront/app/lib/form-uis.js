  ...
  "petition_travel": {
    ...
    fieldsets: [
      ...
      },
      {
        ...
        'compensation_days_manual', 'compensation_days_proposed', 'same_day_return_task', '' , 'trip_days_before', 'trip_days_after', 
        'overnights_sum_cost', '', 'compensation_final', '', 'compensation_level', '', 'total_cost', '',]
      },
    ],
    layout: {
      flex: [
        50, 100, 100, 50, 50, 50, 50, 50, 100, 50,  //10
        50, 50, 50, 50, 50, 50, 50, 50, 50, 50,     //20
        50, 50, 50, 50, 50, 50, 50, 50, 50, 50,     //30
        50, 50, 50, 33, 50, 50, 50, 50, 50, 50,     //40
        50, 50, 50, 50, 50, 50, 50, 100, 50, 50,    //50 
        50, 50, 50, 50, 50, 40, 10, 20, 80, 100,    //60 
        50, 50, 50, 50, 50, 50, 100, 100, 40, 10    //70 
      ] 
    }
  }
};
