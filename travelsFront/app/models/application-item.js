...
export default DS.Model.extend({
  ...
  participation_local_cost: DS.attr('formatted-number', { type: 'string' }),
  ...
  participation_cost: DS.attr('formatted-number', { type: 'string' }),
  ...
  overnights_sum_cost: DS.attr('formatted-number', { type: 'string', disabled: true }),
  compensation_cost: DS.attr('formatted-number', { type: 'string', disabled: true }),
  total_cost_calculated: DS.attr('formatted-number', { type: 'string', disabled: true }),
  withdrawn: DS.attr('boolean', { disabled: true, displayComponent: 'display-boolean' }),
  // compensation - user fields
  additional_expenses: DS.attr('formatted-number', { type: 'string' }),
  ...
  compensation_final: DS.attr('formatted-number', { type: 'string' }),
  timesheeted: DS.attr('boolean'),
  new_id: DS.attr(),
  additional_expenses_grnet: DS.attr('formatted-number', { type: 'string' }),
