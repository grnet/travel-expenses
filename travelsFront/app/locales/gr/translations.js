...
export default {
  ...
  'password.forgot.success': 'Εφόσον έχετε ενεργό λογαριασμό, θα λάβετε οδηγίες για την υπενθύμιση του συνθηματικού σας στο email σας',
  ...
  'transportation_type.label': 'Είδος Μετακίνησης',
