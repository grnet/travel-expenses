export default {
  ...
  'accommodation_cost.label': 'Διανυκτέρευση (Ημερήσια)',
 	'accommodation_local_cost.label': 'Διανυκτέρευση (Ημερήσια)',
  'accommodation_local_cost_user.label': 'Καταχώρηση Χρήστη',
 	'accommodation_local_currency.label': 'Νόμισμα',
 	'additional_expenses_initial.label': 'Λοιπά Έξοδα Μετακίνησης',
  'participation_cost.label': 'Κόστος Συμμετοχής',
 	'participation_local_cost.label': 'Κόστος Συμμετοχής',
  'participation_local_cost_user.label': 'Καταχώρηση Χρήστη',
