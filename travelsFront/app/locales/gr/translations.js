export default {
  ...
  +'Σημειώνεται ότι πριν την τελική υποβολή θα πρέπει να κατεβάσετε την Αίτηση Δαπάνης Μετακίνησης, μέσω της επιλογής που δίνεται από τη λίστα των αιτήσεων.'+'<br>'+'<br>'
