export default {
  ...
  +'Το συγκεκριμένο έγγραφο θα πρέπει να το επισυνάπτετε πάντοτε στον φυσικό φάκελο με τα αποδεικτικά έγγραφα των εξόδων που'+'<b>'+' θα πρέπει '+'</b>'+'να προσκομίσετε στο Λογιστήριο.',
