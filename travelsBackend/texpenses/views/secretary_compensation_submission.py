...
from texpenses.models import SecretaryCompensationSubmission
...
def cancel(self, request, pk=None):
    ...
    try:
        ...
        headers = {'location':
                   reverse('secretarycompensationsubmission-detail',
                           args=[petition_id])}
...
def get_queryset(self):
    return SecretaryCompensationSubmission.objects.all()
