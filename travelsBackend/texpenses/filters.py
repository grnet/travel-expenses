...
class PetitionFilter(filters.FilterSet):
    ...
    first_name = filters.CharFilter(name='first_name',
                                    distinct=True, lookup_expr='unaccent__icontains')
