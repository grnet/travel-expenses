...
#==============================================================================
    ...
    ('applications', 'update', 'USER', 'travel_info/arrival_date','usersaved', '*'),
    ...
    ('applications', 'update', 'USER', 'travel_info/arrival_date','usercompensationsaved', '*'),
    ...
    ('applications', 'update', 'USER', 'travel_info/arrival_date','presidentapproved', '*'),
    ...
    ('applications', 'destroy', 'MANAGER', '*', 'usersaved_and_belongs', '*'),
    ('applications', 'submit', 'MANAGER', '*', 'usersaved_and_belongs', '*'),
    ('applications', 'cancel', 'MANAGER', '*',  'usersaved_and_belongs', '*'),
    ('applications', 'update', 'MANAGER', 'manager_movement_approval', 'usersubmitted_notbelongs', '*'),
    ('applications', 'update', 'MANAGER', 'project', 'usersaved_and_belongs', '*'),
    ('applications', 'update', 'MANAGER', 'reason', 'usersaved_and_belongs', '*'),
    ('applications', 'update', 'MANAGER', 'task_start_date', 'usersaved_and_belongs', '*'),
    ('applications', 'update', 'MANAGER', 'task_end_date', 'usersaved_and_belongs', '*'),
    ('applications', 'update', 'MANAGER', 'participation_cost', 'usersaved_and_belongs', '*'),
    ('applications', 'update', 'MANAGER', 'user_recommendation', 'usersaved_and_belongs','*'),
    ('applications', 'update', 'MANAGER', 'travel_info/departure_point','usersaved_and_belongs', '*'),
    ('applications', 'update', 'MANAGER', 'travel_info/arrival_point','usersaved_and_belongs', '*'),
    ('applications', 'update', 'MANAGER', 'travel_info/depart_date','usersaved_and_belongs', '*'),
    ('applications', 'update', 'MANAGER', 'travel_info/arrival_date','usersaved_and_belongs', '*'),
    ...
    ('applications', 'update', 'SECRETARY', 'travel_info/arrival_date','secretarysaved', '*'),
    ...
    ('applications', 'update', 'SECRETARY', 'travel_info/arrival_date','usersubmitted', '*'),
