...
#==============================================================================
    ...
    # user
    ('applications', 'create', 'USER', 'project', '*', '*'),
    ('applications', 'create', 'USER', 'reason', '*', '*'),
    ('applications', 'create', 'USER', 'task_start_date', '*', '*'),
    ('applications', 'create', 'USER', 'task_end_date', '*', '*'),
    ('applications', 'create', 'USER', 'participation_cost', '*', '*'),
    ('applications', 'create', 'USER', 'participation_local_cost', '*', '*'),
    ('applications', 'create', 'USER', 'participation_local_currency', '*', '*'),
    ('applications', 'create', 'USER', 'user_recommendation', '*', '*'),
    ('applications', 'create', 'USER', 'transportation_type', '*', '*'),
    ('applications', 'create', 'USER', 'travel_info/departure_point','*', '*'),
    ('applications', 'create', 'USER', 'travel_info/arrival_point','*', '*'),
    ('applications', 'create', 'USER', 'travel_info/depart_date','*', '*'),
    ('applications', 'create', 'USER', 'travel_info/return_date','*', '*'),
    ...
    ('applications', 'update', 'USER', 'transportation_type', 'ownedusersaved', '*'),
    ...
    #manager
    ('applications', 'create', 'MANAGER', 'project', '*', '*'),
    ('applications', 'create', 'MANAGER', 'reason', '*', '*'),
    ('applications', 'create', 'MANAGER', 'task_start_date', '*', '*'),
    ('applications', 'create', 'MANAGER', 'task_end_date', '*', '*'),
    ('applications', 'create', 'MANAGER', 'participation_cost', '*', '*'),
    ('applications', 'create', 'MANAGER', 'participation_local_cost', '*', '*'),
    ('applications', 'create', 'MANAGER', 'participation_local_currency', '*', '*'),
    ('applications', 'create', 'MANAGER', 'user_recommendation', '*','*'),
    ('applications', 'create', 'MANAGER', 'transportation_type', '*','*'),
    ('applications', 'create', 'MANAGER', 'travel_info/departure_point','*', '*'),
    ('applications', 'create', 'MANAGER', 'travel_info/arrival_point','*', '*'),
    ('applications', 'create', 'MANAGER', 'travel_info/depart_date','*', '*'),
    ('applications', 'create', 'MANAGER', 'travel_info/return_date','*', '*'),
    ...
    ('applications', 'update', 'MANAGER', 'transportation_type', 'ownedusersaved','*'),
    ...
    ('travel-files', 'destroy', 'MANAGER', '*', 'owned', ''),
    ('travel-files', 'destroy', 'HELPDESK', '*', 'owned', ''),
    ('applications', 'upload', 'USER', '*', '*', '*'),
    ('applications', 'upload', 'MANAGER', '*', '*', '*'),
    ('applications', 'upload', 'HELPDESK', '*', '*', '*'),
]
